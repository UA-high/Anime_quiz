        ...
        <div className="w-full bg-white border-[2.5px] border-black rounded-2xl shadow-[6px_6px_0px_#111] p-8 relative">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="flex-1 bg-[#F5F4EF] border-[2px] border-black rounded-xl py-2 font-['Gabarito',sans-serif] font-bold text-xs text-black shadow-[2px_2px_0_#111] hover:bg-[#E5E4DF] transition-all cursor-pointer"
            >
              Demo User
            </button>
            <button
              ...
              className="flex-1 bg-[#FDE047] border-[2px] border-black rounded-xl py-2 font-['Gabarito',sans-serif] font-bold text-xs text-black shadow-[2px_2px_0_#111] hover:bg-[#FACC15] transition-all cursor-pointer"
            >
              Demo Admin
            </button>
          </div>
